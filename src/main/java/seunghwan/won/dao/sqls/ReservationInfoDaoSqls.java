...
//            "from reservation_info where reservation_email = :email";
    ...
    public static final String SELECT_ALL_BY_EMAIL = "select id as reservationInfoID, product_id as productID, " +
            "display_info_id as displayInfoID, reservation_name as reservationName, reservation_tel as reservationTelephone, " +
            "reservation_email as reservationEmail, reservation_date as reservationDate, cancel_flag as cancelYn, " +
