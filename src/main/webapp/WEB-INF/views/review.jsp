        ...
        <div class="wrap_review_list">
            <div class="review_header">
                <div class="top_title gr">
                    <a href="detail?id=${displayInfo.productID}" class="btn_back" title="이전 화면으로 이동"> <i
                ...
                <div class="review_box">
                    ...
                    <div class="short_review_area">
                        <div class="grade_area"><span class="graph_mask"> <em class="graph_value"
                                                                              style="width: 88%;"></em> </span> <strong
                                class="text_value"> <span>${averageScore}</span> <em class="total">5.0</em> </strong>
                            <span
                                    class="join_count"><em class="green">${commentList.size()}건</em> 등록</span></div>
...
<%--                                                                                                  src="https://ssl.phinf.net/naverbooking/20170409_273/1491699111250gxiyJ_JPEG/image.jpg?type=f300_300"--%>
                                                                                                  src="http://localhost:8080/api/img/commentThumbnail?id=${comment.commentId}"
                                                                                                  alt="리뷰이미지"> </a>
                                                <span
                                        ...
                                        <div class="info_area">
                                            <div class="review_info"><span class="grade">${comment.score}</span> <span
                                                    ...
                                                    class="date">${comment.createDate.split(" ")[0].replaceAll("-", ":")} 방문</span>
                                            </div>
                                        </div>
                                    </div>
                                </li>
    ...
    <li class="list_item">
        <div>
            ...
            <div class="info_area">
                <div class="review_info"><span class="grade">${comment.score}</span> <span
                        class="name">${comment.reservationName}</span> <span
                        class="date">2017.4.8. 방문</span></div>
            </div>
        </div>
    </li>
</script>
