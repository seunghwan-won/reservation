...
<head>
    <meta http-equiv="Content-Type" productContent="text/html; charset=UTF-8">
    ...
    <![endif]-->
    <meta http-equiv="X-UA-Compatible" productContent="IE=Edge">
    <meta http-equiv="cache-control" productContent="no-cache">
    <meta http-equiv="expires" productContent="Tue, 01 Jan 1980 1:00:00 GMT">
    <meta http-equiv="pragma" productContent="no-cache">
...
<app>
    ...
    <!---->
    <div class="_view_content" ui-view="productContent" id="container" >
        <booked-confirm>
...
<script src="/resource/js/bookinglogin.js"></script>
</body>
</html>
